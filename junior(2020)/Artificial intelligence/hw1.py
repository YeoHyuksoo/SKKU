...
random_num = random.randint(1, 16000)
...
"""x = ['50', '100', '200', '400', '800', '1600', '3200', '6400', '12800']
funny = []
useful = []
cool = []
positive = []"""
...
for i in range(0, 9, 1):
    ...
    """print(100 - correct_funny*100 / 3200)
    funny.append(100 - correct_funny*100 / 3200)
    print(100 - correct_useful*100 / 3200)
    useful.append(100 - correct_useful * 100 / 3200)
    print(100 - correct_cool*100 / 3200)
    cool.append(100 - correct_cool * 100 / 3200)
    print(100 - correct_positive*100 / 3200)
    positive.append(100 - correct_positive * 100 / 3200)
    print()
    print("baseline model")
    if funny_cnt > 1600:
        print(100 - (correct_funny - correct_not_funny)*100 / 3200)
        funny.append(100 - (correct_funny - correct_not_funny)*100 / 3200)
    else:
        print(100 - (correct_not_funny*100 / 3200))
        funny.append(100 - (correct_not_funny*100 / 3200))
    if useful_cnt > 1600:
        print(100 - (correct_useful - correct_not_useful)*100 / 3200)
        useful.append(100 - (correct_useful - correct_not_useful)*100 / 3200)
    else:
        print(100 - (correct_not_useful*100 / 3200))
        useful.append(100 - (correct_not_useful*100 / 3200))
    if cool_cnt > 1600:
        print(100 - (correct_cool - correct_not_cool)*100 / 3200)
        cool.append(100 - (correct_cool - correct_not_cool)*100 / 3200)
    else:
        print(100 - (correct_not_cool*100 / 3200))
        cool.append(100 - (correct_not_cool*100 / 3200))
    if positive_cnt > 1600:
        print(100 - (correct_positive - correct_not_positive)*100 / 3200)
        positive.append(100 - (correct_positive - correct_not_positive)*100 / 3200)
    else:
        print(100 - (correct_not_positive*100 / 3200))
        positive.append(100 - (correct_not_positive*100 / 3200))
    print()"""
...
"""plt.plot(x, funny, label='funny')
plt.plot(x, useful, label='useful')
plt.plot(x, cool, label='cool')
